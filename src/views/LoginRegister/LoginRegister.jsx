...
const LoginRegister = (props) => {
    ...
    const login = (event) =>{
        ...
        axios.post(`${process.env.REACT_APP_LINK}/api/login`, form, {withCredentials:true}) // {withCredentials:true} allow us to pass in cookies back and forth(lol)
            .then( res => {
    ...
    const register = (event) => {
        ...
        axios.post(`${process.env.REACT_APP_LINK}/api/register`, form, {withCredentials:true})// {withCredentials:true} allow us to pass in cookies back and forth(lol)
            .then(res => {
                if(res.data.message){
