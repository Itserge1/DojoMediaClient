...
const PostForm = () => {
    ...
    const makeApost = async (event) => {
        ...
        if (file != null) {
            ...
            axios.post(`${process.env.REACT_APP_LINK}/api/newpost`, NewPost, { withCredentials: true })
                .then(res => {
            ...
            axios.post(`${process.env.REACT_APP_LINK}/api/newpost`, form, { withCredentials: true })
                .then(res => {
                    console.log({ message: "Here is your res", res: res });
                    window.location.reload() // this code refresh the page after a post
                })
